...
export const metadata: Metadata = {
  title: "من نحن",
  description:
    "قصة Q-Trust: منصة وُلدت داخل جمعية تحفيظ قرآن حقيقية في صفاقس، وبُنيت حول احتياجات المديرين والمعلّمين والعائلات.",
}

const VALUES = [
  {
    title: "وُلد من الميدان، لا من مكتب",
    body: "بدأ Q-Trust كنظام داخلي لجمعية تحفيظ قرآن في صفاقس — دفاتر حضور تُملأ يدويًا، اشتراكات تُتابَع في جداول متفرقة، وأولياء يسألون ولا يجدون جوابًا سريعًا. بنينا الحل الذي احتاجته الجمعية فعلًا، ثم جعلناه متاحًا لكل جمعية.",
  },
  {
  ...
  },
  {
    ...
    body: "نركّب المنصة معك، ندرّب فريقك، ونبقى على الهاتف. نموّنا يأتي من رضا الجمعيات وتزكيتها لبعضها — لا من عقود تُوقَّع وتُنسى.",
  },
]
      ...
      <section className="pt-36 pb-6">
        <div className="mk-container">
          <Reveal className="max-w-[46ch]">
            ...
            <h1 className="mk-display mk-h2">أداة بُنيت داخل جمعية، لخدمة الجمعيات</h1>
            <p className="mk-lead mt-5">
              Q-Trust منصة تونسية لإدارة جمعيات ومدارس تحفيظ القرآن — الحضور، المدفوعات، والمتابعة
              في نظام واحد يحترم طريقة عمل هذه المؤسسات.
            </p>
          </Reveal>
        </div>
      </section>
