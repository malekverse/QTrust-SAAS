  ...
  if (done) {
    return (
      <div className="mk-card p-10 text-center">
        ...
        <h2 className="mk-display mt-5 text-2xl font-bold">Request received</h2>
        <p className="mk-body mt-3 max-w-[40ch] mx-auto">
          We will contact you within one business day to schedule a meeting — usually
          with a short call to understand your school&apos;s needs first.
        </p>
      </div>
    )
  }
  ...
  return (
    <form onSubmit={onSubmit} className="mk-card p-7 sm:p-9 space-y-5" noValidate>
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <div className="space-y-1.5">
          <label htmlFor="lead-assoc" className="text-sm font-medium">School / association name *</label>
          <input
            id="lead-assoc"
            className={inputCls}
        ...
        <div className="space-y-1.5">
          <label htmlFor="lead-email" className="text-sm font-medium">Email (optional)</label>
          <input
            id="lead-email"
            type="email"
            className={inputCls}
        ...
        <div className="space-y-1.5">
          <label htmlFor="lead-count" className="text-sm font-medium">Approximate number of students</label>
          <select
            id="lead-count"
            className={inputCls}
      ...
      <div className="space-y-1.5">
        <label htmlFor="lead-message" className="text-sm font-medium">Notes (optional)</label>
        <textarea
          id="lead-message"
          rows={3}
          className={inputCls}
      ...
      <p className="text-center text-xs text-foreground/50">
        By sending this request, you agree to our <a href="/en/privacy" className="underline underline-offset-2">privacy policy</a>. We do not share your data with any third party.
      </p>
    </form>
  )
}
